...
var config = new Configuration
{
    StorageProvider = new CapacityBasedStorageProvider(new[]
            {
                new FileSystemStorage(new DirectoryInfo(@"C:\Users\Ronnie\Desktop\BlobServer\A"), "A"),
                new FileSystemStorage(new DirectoryInfo(@"C:\Users\Ronnie\Desktop\BlobServer\B"), "B"),
                new FileSystemStorage(new DirectoryInfo(@"C:\Users\Ronnie\Desktop\BlobServer\C"), "C"),
